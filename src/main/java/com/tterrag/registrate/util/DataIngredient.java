...
/**
 * A helper for data generation when using ingredients as input(s) to recipes.<br> It remembers the name of the primary
 * ingredient for use in creating recipe names/criteria.
 * <p>
...
public final class DataIngredient extends Ingredient {
    ...
    private DataIngredient(Ingredient parent, Named<Item> tag) {
        ...
        this.parent = parent;
        this.id = tag.getName();
        this.criteriaFactory = prov -> RegistrateRecipeProvider.hasItem(tag);
    }
