...
public final class DataIngredient extends Ingredient {
    ...
    private final BiFunction<RegistrateRecipeProvider, MinMaxBounds.IntBound, InventoryChangeTrigger.Instance> boundedCriteriaFactory;
    ...
    private DataIngredient(Ingredient parent, IItemProvider item) {
        ...
        this.boundedCriteriaFactory = (prov, bound) -> prov.hasItem(bound, item);
    }
    ...
    private DataIngredient(Ingredient parent, Tag<Item> tag) {
        ...
        this.boundedCriteriaFactory = (prov, bound) -> prov.hasItem(bound, tag);
    }
    ...
    private DataIngredient(Ingredient parent, ResourceLocation id, ItemPredicate... predicates) {
        ...
        this.boundedCriteriaFactory = (prov, bound) -> { throw new UnsupportedOperationException("Bounds must be included in the predicates, they cannot be provided here!"); };
    }
    ...
    public InventoryChangeTrigger.Instance getCritereon(RegistrateRecipeProvider prov, MinMaxBounds.IntBound bounds) {
        return boundedCriteriaFactory.apply(prov, bounds);
    }
