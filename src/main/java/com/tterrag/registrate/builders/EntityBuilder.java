...
import com.tterrag.registrate.providers.loot.RegistrateEntityLoot;
...
public class EntityBuilder<T extends Entity, P> extends AbstractBuilder<EntityType<?>, EntityType<T>, P, EntityBuilder<T, P>> {
    ...
    @Nullable
    private EntityRendererProvider<? super T> renderer;
    private @Nullable
    ItemBuilder<LazySpawnEggItem<T>, EntityBuilder<T, P>> spawnEggBuilder;
     ...
     * <p>
     *
     * @param renderer A (server safe) supplier to an {@link IRenderFactory} that will provide this entity's renderer
     * @return this {@link EntityBuilder}
     * @apiNote This requires the {@link Class} of the entity object, which can only be gotten by inspecting an instance
     * of it. Thus, the entity will be constructed with a {@code null} {@link Level} to register the renderer.
     */
    public EntityBuilder<T, P> renderer(EntityRendererProvider<? super T> renderer) {
    ...
    protected void registerRenderer() {
        OneTimeEventReceiver.addModListener(FMLClientSetupEvent.class, $ -> {
            ...
            if (renderer != null) {
                try {
                    RenderingRegistry.registerEntityRenderingHandler(getEntry(), renderer);
                } catch (Exception e) {
     ...
     *
     * @param attributes A supplier to the attributes for this entity, usually of the form {@code
     *                   EntityClass::createAttributes}
     * @return this {@link EntityBuilder}
    ...
    public EntityBuilder<T, P> attributes(Supplier<AttributeSupplier.Builder> attributes) {
        ...
        OneTimeEventReceiver.addModListener(EntityAttributeCreationEvent.class, e -> e.put(
                (EntityType<LivingEntity>) getEntry(), attributes.get().build()
        ));
        return this;
    }
    ...
    public EntityBuilder<T, P> spawnPlacement(SpawnPlacements.Type type, Heightmap.Types heightmap, SpawnPlacements.SpawnPredicate<T> predicate) {
        ...
        this.onRegister(t -> {
            ...
            */
            SpawnPlacements.register((EntityType<Mob>) t, type, heightmap, (SpawnPlacements.SpawnPredicate<Mob>) predicate);
        });
        return this;
    }
     ...
     * @return this {@link EntityBuilder}
     * @deprecated This does not work properly, see <a href="https://github.com/MinecraftForge/MinecraftForge/pull/6299">this
     * issue</a>.
     * <p>
    ...
    /**
     * Create a spawn egg item for this entity using the given colors, and return the builder for further
     * configuration.
     *
     * @param primaryColor   The primary color of the egg
     * @param secondaryColor The secondary color of the egg
     ...
     * accept a {@link DataGenContext}, but instead a {@link RegistrateEntityLoot}, for creating specifically entity
     * loot tables.
     *
     * @param cons The callback which will be invoked during entity loot table creation.
     * @return this {@link EntityBuilder}
     */
    public EntityBuilder<T, P> loot(NonNullBiConsumer<RegistrateEntityLoot, EntityType<T>> cons) {
     ...
     */
    @SafeVarargs
    public final EntityBuilder<T, P> tag(Named<EntityType<?>>... tags) {
